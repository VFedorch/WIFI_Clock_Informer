...
<a href="/" class="btn btn--m btn--blue""><</a>&nbsp;&nbsp;<strong>Screen settings</strong>
<hr>
	<form action="" method="get">
		<table border="0"  cellspacing="0" cellpadding="3" >
			<tr>
			<td align="right">Day mode starts at: </td>
			<td>
		...
		<tr>
			<td align="right">Day Mode - brightness: </td>
			<td>
		...
		<tr>
			<td align="right">Night mode starts at: </td>
			<td>
				<select id="timen" name="timen">
					<option value="0">0</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
		...
		<tr>
			<td align="right">Night mode - brightness:</td>
			<td>
				<select id="tbn" name="tbn">
					<option value="0">0</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
