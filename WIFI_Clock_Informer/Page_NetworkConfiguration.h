...
<a href="/"  class="btn btn--m btn--blue""><</a>&nbsp;&nbsp;<strong>Network settings</strong>
	<hr>Router connection settings:<br>
	<form action="" method="get">
		<table border="0"  cellspacing="0" cellpadding="4" style="width:380" >
			<tr>
				<td align="right">SSID:</td><td><input type="text" id="ssid" name="ssid" value=""></td>
			</tr>
			<tr>
				<td align="right">Password:</td><td><input type="text" id="password" name="password" value=""></td>
			</tr>
			<tr>
				<td align="right">DHCP:</td><td><input type="checkbox" id="dhcp" name="dhcp"></td>
			</tr>
			<tr>
				<td align="right">IP:</td><td><input type="text" id="ip_0" name="ip_0" size="2">.<input type="text" id="ip_1" name="ip_1" size="2">.<input type="text" id="ip_2" name="ip_2" size="2">.<input type="text" id="ip_3" name="ip_3" value="" size="2"></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right">DNS:</td><td><input type="text" id="dns_0" name="dns_0" size="2">.<input type="text" id="dns_1" name="dns_1" size="2">.<input type="text" id="dns_2" name="dns_2" size="2">.<input type="text" id="dns_3" name="dns_3" size="2"></td>
			</tr>
			<tr>
	...
	<hr><strong>Connection status:</strong>
		<div id="connectionstate">No data available</div>
		<hr><strong>Networks:</strong><br>
		<table border="0"  cellspacing="3" style="width:380px" >
			<tr>
				<td><div id="networks">Scanning...</div></td>
			</tr>
			<tr>
				<td align="center"><a href="javascript:GetState()" style="width:150px" class="btn btn--m btn--blue">Refresh</a></td>
			</tr>
		</table>
	<br>
<script>
...
void send_connection_state_values_html()
{
	...
	else if (WiFi.status() == 1) state = "NO NETWORKS AVAILABLE";
	else if (WiFi.status() == 2) state = "Scan complete";
	else if (WiFi.status() == 3) state = "CONNECTED";
	else if (WiFi.status() == 4) state = "CONNECTION ERROR";
	else if (WiFi.status() == 5) state = "Disconnected";
	else if (WiFi.status() == 6) state = "NO CONNECTIONS";
    ...
    {
		Networks = "Networks available: " +String(n) + "<br>";
		Networks += "<table border='0' cellspacing='0' cellpadding='3'>";
		Networks += "<tr bgcolor='#3D3D3D' ><td><strong>Name</strong></td><td><strong>Quality</strong></td><td><strong>Protection</strong></td><tr>";
		for (int i = 0; i < n; ++i)
		{
			int quality=0;
			if(WiFi.RSSI(i) <= -100)
