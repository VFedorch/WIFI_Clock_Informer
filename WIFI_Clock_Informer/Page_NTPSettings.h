...
<a href="/"  class="btn btn--m btn--blue""><</a>&nbsp;&nbsp;<strong>NTP settings</strong>
<hr>
	<form action="" method="get">
		<table border="0"  cellspacing="0" cellpadding="3" >
			<tr>
				<td align="right">NTP server:</td>
				<td align="left"><input type="text" id="ntpserver" name="ntpserver" maxlength="172" value=""></td>
			</tr>
			<tr>
				<td align="right">Update each:<br> </td>
				<td align="left"><input type="text" id="update" name="update" size="3" maxlength="6" value=""> minutes<br> (0 = do not update)</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right">Daylight saving time:</td><td><input type="checkbox" id="dst" name="dst"></td>
			</tr>
			<tr>
