...
<script src="microajax.js"></script> 
	<a href="/" class="btn btn--m btn--blue"><</a>&nbsp;&nbsp;<strong>Network information</strong>
	<hr>
		<table border="0"  cellspacing="0" cellpadding="4" style="width:310px" >
			<tr>
				<td align="right">SSID :</td>
				<td align="left"><span id="x_ssid"></span></td>
			</tr>
			<tr>
				<td align="right">IP :</td>
				<td align="left"><span id="x_ip"></span></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center">
					<a href="javascript:GetState()" class="btn btn--m btn--blue">Refresh</a>
				</td>
			</tr>
		</table>
	<br>
